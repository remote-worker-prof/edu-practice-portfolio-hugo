...
- Код сайта находится в корне репозитория (Hugo проект уже создан).
- Тема: Hugo Book (подключена как git submodule).
- Workflow деплоя: `.github/workflows/hugo.yaml`.
- Учебники и материалы: `practice/guides/README.md` и `practice/templates/`.
...
## Учебники
Полные учебники лежат в `practice/guides/README.md`.
